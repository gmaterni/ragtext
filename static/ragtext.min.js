...
module$static$js$app_ui.bindEventListener=bindEventListener$$module$static$js$app_ui;module$static$js$app_ui.getTheme=getTheme$$module$static$js$app_ui;module$static$js$app_ui.showHtmlThread=showHtmlThread$$module$static$js$app_ui;module$static$js$app_ui.wnds=wnds$$module$static$js$app_ui;const getClientIp$$module$static$js$services$logger=async()=>{try{const a=await fetch("https://api.ipify.org?format=json");return a.ok?(await a.json()).ip:"IP non recuperabile"}catch(a){return console.error("Errore nel recuperare l'IP:",a),"IP non recuperabile"}},sendLog$$module$static$js$services$logger=async(a,b={})=>{const c=await getClientIp$$module$static$js$services$logger();a={clientId:a,timestamp:(new Date).toISOString(),ip:c,userAgent:navigator.userAgent,...b};try{return(await fetch("https://simple-moniotr-default-rtdb.europe-west1.firebasedatabase.app/visite.json",
