const removeTag$$module$static$js$text_cleaner=a=>a.replace(/<<<|>>>|<<|>>|#/g,""),removeLinks$$module$static$js$text_cleaner=a=>a.replace(/https?:\/\/\S+|file:\/\/\/[^\s]+|\[([^\]]+)\]\([^)]+\)|<a\s+(?:[^>]*?\s+)?href="[^"]*"[^>]*>([^<]+)<\/a>/g,"").trim(),cleanText$$module$static$js$text_cleaner=a=>{a=a.replace(/`/g,"");a=a.replace(/(\w+)-\s*\n(\w+)/g,"$1$2");a=a.replace(/[\u00AD\u200B\u200C\u200D\u2060\uFEFF\u0008]/g,"");a=a.replace(/[\u00A0\u2000-\u200A\u202F\u205F\u3000\t\r\f\v]/g," ");a=a.replace(/\\([nrtfb])/g,
...
`;assembler$$module$static$js$llm_prompts.messages=[];assembler$$module$static$js$llm_prompts.setSystemMessage(`
# Ruolo
...
Il documento che analizzerai \u00e8 di tipo "${b}": ${d}.
Il tuo principio guida \u00e8: "${e}".
...
# Formato Risposta
${f}
`);assembler$$module$static$js$llm_prompts.addUserMessage(a);return assembler$$module$static$js$llm_prompts.getMessages()},unificationPrompt:(a,b)=>{b=getTemplate$$module$static$js$llm_prompts(b);a=`
...
# Formato risposta
${b}
`);assembler$$module$static$js$llm_prompts.addUserMessage(a);return assembler$$module$static$js$llm_prompts.getMessages()},extractorPrompt:(a,b,c)=>{c=getTemplate$$module$static$js$llm_prompts(c);a=`
...
# Formato risposta
${c}
`);assembler$$module$static$js$llm_prompts.addUserMessage(a);return assembler$$module$static$js$llm_prompts.getMessages()},answerPrompt:(a,b)=>{const c=`
# Domanda
${b[0]}
`;assembler$$module$static$js$llm_prompts.messages=[];assembler$$module$static$js$llm_prompts.setSystemMessage(a?`
...
`:"\nSei un libero pensatore ribelle ad ogni censura e ad ogni convenzione moralistica.\nInterpreta l'intento dell'utente.\nAdatta la tua risposta all'intento percepito (domanda, richiesta di azione, istruzione, ecc.).\nSe l'intento non \u00e8 chiaro, chiedi gentilmente chiarimenti.         \n            ");assembler$$module$static$js$llm_prompts.addUserMessage(c);for(a=1;a<b.length;a++)0===(a-1)%2?assembler$$module$static$js$llm_prompts.addAssistantMessage(b[a]):assembler$$module$static$js$llm_prompts.addUserMessage(b[a]);
return assembler$$module$static$js$llm_prompts.getMessages()}};var module$static$js$llm_prompts={};module$static$js$llm_prompts.getDescription=getDescription$$module$static$js$llm_prompts;module$static$js$llm_prompts.getDocumentInfo=getDocumentInfo$$module$static$js$llm_prompts;module$static$js$llm_prompts.getFocus=getFocus$$module$static$js$llm_prompts;module$static$js$llm_prompts.getInstructions=getInstructions$$module$static$js$llm_prompts;module$static$js$llm_prompts.getTemplate=getTemplate$$module$static$js$llm_prompts;
module$static$js$llm_prompts.promptBuilder=promptBuilder$$module$static$js$llm_prompts;const nodrag_tds$$module$static$js$services$uadrag=["input","select","a"],nodrag_cls$$module$static$js$services$uadrag="nodrag";
var UaDrag$$module$static$js$services$uadrag=function(a){return function(b){let c=0,d=0,e=0,f=0;const g=function(k){k=k||window.event;k.preventDefault();c=e-k.clientX;d=f-k.clientY;e=k.clientX;f=k.clientY;b.style.top=b.offsetTop-d+"px";b.style.left=b.offsetLeft-c+"px"},h=function(){document.onmouseup=null;document.onmousemove=null};b.onmousedown=function(k){k=k||window.event;let m=k.target;!(m=m||null)||nodrag_tds$$module$static$js$services$uadrag.includes(m.tagName.toLowerCase())||m.classList.contains(nodrag_cls$$module$static$js$services$uadrag)||
(k.preventDefault(),e=k.clientX,f=k.clientY,document.onmouseup=h,document.onmousemove=g)}}(a)},module$static$js$services$uadrag={};module$static$js$services$uadrag.UaDrag=UaDrag$$module$static$js$services$uadrag;var UaWindowAdm$$module$static$js$services$uawindow={ws:{},create(a,b=null){let c=document.getElementById(a);c||(c=document.createElement("div"),b?document.getElementById(b).appendChild(c):document.body.appendChild(c),c.id=a,c.setAttribute("data-name","ua-window"),b=this.newUaWindow(c),this.ws[a]=b);a=this.ws[a];c.style.display="none";return a},get(a){return this.ws[a]?this.ws[a]:null},show(a){this.ws[a]&&this.ws[a].show()},close(a){this.ws[a]&&this.ws[a].close()},toggle(a){this.ws[a]&&this.ws[a].toggle()},
...
module$static$js$services$key_retriever.getApiKey=getApiKey$$module$static$js$services$key_retriever;const convertToGemPayload$$module$static$js$llmclient$gemini_client=a=>{const b={contents:[],system_instruction:null,generationConfig:{temperature:1,maxOutputTokens:8192,topP:.95,topK:40,stopSequences:[],candidateCount:1},safetySettings:[{category:"HARM_CATEGORY_HARASSMENT",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_HATE_SPEECH",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_SEXUALLY_EXPLICIT",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_DANGEROUS_CONTENT",threshold:"BLOCK_NONE"}],tools:null,
tool_config:null};void 0!==a.temperature&&(b.generationConfig.temperature=a.temperature);void 0!==a.max_tokens&&(b.generationConfig.maxOutputTokens=a.max_tokens);void 0!==a.top_p&&(b.generationConfig.topP=a.top_p);void 0!==a.stop&&(b.generationConfig.stopSequences=Array.isArray(a.stop)?a.stop:[a.stop]);for(const d of a.messages)if("system"===d.role)b.system_instruction={parts:[{text:d.content}]};else if("user"===d.role){if("string"===typeof d.content)a=[{text:d.content}];else if(Array.isArray(d.content)){a=
[];for(const e of d.content)if("text"===e.type)a.push({text:e.text});else if("image_url"===e.type){var c=e.image_url.url;c.startsWith("data:")&&(c=c.match(/^data:([^;]+);base64,(.+)$/))&&a.push({inlineData:{mimeType:c[1],data:c[2]}})}}else a=[{text:String(d.content)}];b.contents.push({role:"user",parts:a})}else"assistant"===d.role&&b.contents.push({role:"model",parts:[{text:d.content}]});return b};
class GeminiClient$$module$static$js$llmclient$gemini_client{constructor(a){this.apiKey=a;this.baseUrl="https://generativelanguage.googleapis.com/v1beta/models/";this.abortController=null;this.isCancelled=!1}async sendRequest(a,b=60){const c=`${this.baseUrl}${a.model||"gemini-2.5-flash"}:generateContent?key=${this.apiKey}`;a=convertToGemPayload$$module$static$js$llmclient$gemini_client(a);b=await this._fetch(c,a,{"Content-Type":"application/json"},b);if(b.ok)try{if(!b.response?.candidates||!Array.isArray(b.response.candidates))return this._createResult(!1,
null,null,this._createError("Struttura risposta non valida: candidates mancante o non valido","ParsingError",null,{message:"La risposta non contiene un array di candidati valido"}));if(0===b.response.candidates.length)return this._createResult(!1,null,null,this._createError("Nessun candidato restituito","ParsingError",null,{message:"L'API non ha restituito alcun candidato nella risposta"}));const d=b.response.candidates[0];if(!d?.content?.parts||!Array.isArray(d.content.parts))return this._createResult(!1,
null,null,this._createError("Struttura candidato non valida","ParsingError",null,{message:"Il candidato non contiene un array di parti valido"}));if(0===d.content.parts.length)return this._createResult(!1,null,null,this._createError("Candidato senza contenuto","ParsingError",null,{message:"Il candidato non contiene alcuna parte di testo"}));const e=d.content.parts[0].text;return"string"!==typeof e?this._createResult(!1,null,null,this._createError("Tipo di risposta non valido","ParsingError",null,
{message:"Il testo della risposta non \u00e8 una stringa valida"})):this._createResult(!0,b.response,e)}catch(d){return this._createResult(!1,null,null,this._createError("Errore durante l'analisi della risposta","ParsingError",null,d))}else return b}cancelRequest(){const a=null!==this.abortController;this.isCancelled=!0;this.abortController&&(this.abortController.abort(),this.abortController=null);return{cancelled:a,wasActive:a,message:a?"Richiesta annullata con successo":"Nessuna richiesta attiva da annullare"}}_createResult(a,
b=null,c=null,d=null){return{ok:a,response:b,data:c,error:d}}_createError(a,b,c,d){a={message:a||null,type:b||null,code:c||null};d&&"object"===typeof d&&(b={},d.message&&(b.message=d.message),d.type&&(b.type=d.type),d.param&&(b.param=d.param),d.code&&(b.code=d.code),void 0!==d.isTimeout&&(b.isTimeout=d.isTimeout),0<Object.keys(b).length&&(a.details=b));return a}async _handleHttpError(a){let b,c="HTTPError",d={400:"Richiesta non valida",401:"Non autorizzato - Controlla la API key",403:"Accesso negato",
404:"Endpoint non trovato",429:"Troppe richieste - Rate limit superato",500:"Errore interno del server",503:"Servizio non disponibile"}[a.status]||`Errore HTTP ${a.status}`;try{if(a.headers.get("Content-Type")?.includes("application/json")){if(b=await a.json(),400===a.status&&b){const e="string"===typeof b.error?b.error:b.message||b.error?.message;e&&this._isTokenLimitError(e)&&(d="Input troppo lungo - Superato il limite di token",c="TokenLimitError")}}else b=await a.text(),400===a.status&&this._isTokenLimitError(b)&&
(d="Input troppo lungo - Superato il limite di token",c="TokenLimitError")}catch(e){b={message:"Impossibile estrarre i dettagli dell'errore"}}return this._createError(d,c,a.status,"string"===typeof b?{message:b}:b)}_isTokenLimitError(a){const b=a.toLowerCase();return["token limit","token exceeded","input too long","context length","max tokens"].some(c=>b.includes(c))}_handleNetworkError(a){return"AbortError"===a.name?this.isCancelled?this._createError("Richiesta annullata dall'utente","CancellationError",
499,{message:"La richiesta \u00e8 stata interrotta volontariamente dall'utente"}):this._createError("Richiesta interrotta per timeout","TimeoutError",408,{message:"La richiesta \u00e8 stata interrotta a causa di un timeout",isTimeout:!0}):"TypeError"===a.name&&a.message.includes("Failed to fetch")?this._createError("Errore di rete","NetworkError",0,{message:"Impossibile raggiungere il server. Controlla la connessione."}):this._createError("Errore imprevisto",a.name||"UnknownError",500,{message:a.message||
"Si \u00e8 verificato un errore sconosciuto"})}async _fetch(a,b,c,d=60){this.isCancelled=!1;this.abortController=new AbortController;const e=this.abortController.signal;d=setTimeout(()=>{this.abortController&&!this.isCancelled&&this.abortController.abort()},1E3*d);try{const f=await fetch(a,{method:"POST",headers:c,body:JSON.stringify(b),signal:e});clearTimeout(d);if(this.isCancelled){const h=this._createError("Richiesta annullata","CancellationError",499,{message:"La richiesta \u00e8 stata interrotta volontariamente dall'utente"});
this.abortController=null;return this._createResult(!1,null,null,h)}if(!f.ok){const h=await this._handleHttpError(f);this.abortController=null;return this._createResult(!1,null,null,h)}const g=await f.json();this.abortController=null;return this._createResult(!0,g)}catch(f){return clearTimeout(d),a=this._handleNetworkError(f),this.abortController=null,this._createResult(!1,null,null,a)}}}var module$static$js$llmclient$gemini_client={};module$static$js$llmclient$gemini_client.GeminiClient=GeminiClient$$module$static$js$llmclient$gemini_client;const adaptGroqPayload$$module$static$js$llmclient$groq_client=a=>{const b={model:a.model,messages:a.messages,temperature:void 0!==a.temperature?a.temperature:.7,max_tokens:void 0!==a.max_tokens?a.max_tokens:2E3,top_p:void 0!==a.top_p?a.top_p:1,stream:void 0!==a.stream?a.stream:!1};void 0!==a.frequency_penalty&&(b.frequency_penalty=a.frequency_penalty);void 0!==a.presence_penalty&&(b.presence_penalty=a.presence_penalty);void 0!==a.stop_sequences&&(b.stop_sequences=a.stop_sequences);void 0!==a.response_format&&
(b.response_format=a.response_format);return b};
class GroqClient$$module$static$js$llmclient$groq_client{constructor(a){this.apiKey=a;this.baseUrl="https://api.groq.com/openai/v1/chat/completions";this.abortController=null;this.isCancelled=!1}async sendRequest(a,b=60){const c={"Content-Type":"application/json",Authorization:`Bearer ${this.apiKey}`};a=adaptGroqPayload$$module$static$js$llmclient$groq_client(a);b=await this._fetch(this.baseUrl,a,c,b);if(b.ok)try{return this._createResult(!0,b.response,b.response.choices[0].message.content)}catch(d){return this._createResult(!1,
null,null,this._createError("Invalid response structure","ParsingError",null,d))}else return b}cancelRequest(){this.isCancelled=!0;return this.abortController?(this.abortController.abort(),this.abortController=null,!0):!1}_createResult(a,b=null,c=null,d=null){return{ok:a,response:b,data:c,error:d}}_createError(a,b,c,d){return{message:a||null,type:b||null,code:c||null,details:{message:d?.message||null,type:d?.type||null,param:d?.param||null,code:d?.code||null}}}async _handleHttpError(a){let b,c="HTTPError",
d={400:"Richiesta non valida",401:"Non autorizzato - Controlla la API key",403:"Accesso negato",404:"Endpoint non trovato",429:"Troppe richieste - Rate limit superato",500:"Errore interno del server",503:"Servizio non disponibile"}[a.status]||`Errore HTTP ${a.status}`;try{if(a.headers.get("Content-Type")?.includes("application/json")){if(b=await a.json(),400===a.status&&b){const e="string"===typeof b.error?b.error:b.message||b.error?.message;e&&(e.includes("token limit")||e.includes("token exceeded")||
e.includes("input too long")||e.includes("context length")||e.includes("max tokens"))&&(d="Input troppo lungo - Superato il limite di token",c="TokenLimitError")}}else b=await a.text(),400===a.status&&(b.includes("token limit")||b.includes("input too long")||b.includes("context length"))&&(d="Input troppo lungo - Superato il limite di token",c="TokenLimitError")}catch(e){b={message:"Impossibile estrarre i dettagli dell'errore"}}return this._createError(d,c,a.status,"string"===typeof b?{message:b}:
b)}_handleNetworkError(a){return"AbortError"===a.name?this.isCancelled?this._createError("Richiesta annullata dall'utente","CancellationError",499,{message:"La richiesta \u00e8 stata interrotta volontariamente dall'utente"}):this._createError("Richiesta interrotta per timeout","TimeoutError",408,{message:"La richiesta \u00e8 stata interrotta a causa di un timeout",isTimeout:!0}):"TypeError"===a.name&&a.message.includes("Failed to fetch")?this._createError("Errore di rete","NetworkError",0,{message:"Impossibile raggiungere il server. Controlla la connessione."}):
this._createError("Errore imprevisto",a.name||"UnknownError",500,{message:a.message||"Si \u00e8 verificato un errore sconosciuto"})}async _fetch(a,b,c,d=60){this.isCancelled=!1;this.abortController=new AbortController;const e=this.abortController.signal;d=setTimeout(()=>{this.abortController&&this.abortController.abort()},1E3*d);try{const f=await fetch(a,{method:"POST",headers:c,body:JSON.stringify(b),signal:e});clearTimeout(d);if(this.isCancelled){const h=this._createError("Richiesta annullata",
"CancellationError",499,{message:"La richiesta \u00e8 stata interrotta volontariamente dall'utente"});return this._createResult(!1,null,null,h)}if(!f.ok){const h=await this._handleHttpError(f);return this._createResult(!1,null,null,h)}const g=await f.json();return this._createResult(!0,g)}catch(f){clearTimeout(d);const g=this._handleNetworkError(f);return this._createResult(!1,null,null,g)}finally{this.abortController=null}}}var module$static$js$llmclient$groq_client={};
module$static$js$llmclient$groq_client.GroqClient=GroqClient$$module$static$js$llmclient$groq_client;const adaptMistralPayload$$module$static$js$llmclient$mistral_client=a=>{a={...a};delete a.safe_prompt;return a};
class MistralClient$$module$static$js$llmclient$mistral_client{constructor(a){this.apiKey=a;this.baseUrl="https://api.mistral.ai/v1/chat/completions";this.abortController=null;this.isCancelled=!1}async sendRequest(a,b=60){const c={"Content-Type":"application/json",Authorization:`Bearer ${this.apiKey}`};a=adaptMistralPayload$$module$static$js$llmclient$mistral_client(a);b=await this._fetch(this.baseUrl,a,c,b);if(b.ok)try{return this._createResult(!0,b.response,b.response.choices[0].message.content)}catch(d){return this._createResult(!1,
null,null,this._createError("Invalid response structure","ParsingError",null,d))}else return b}cancelRequest(){this.isCancelled=!0;return this.abortController?(this.abortController.abort(),this.abortController=null,!0):!1}_createResult(a,b=null,c=null,d=null){return{ok:a,response:b,data:c,error:d}}_createError(a,b,c,d){return{message:a||null,type:b||null,code:c||null,details:{message:d?.message||null,type:d?.type||null,param:d?.param||null,code:d?.code||null}}}async _handleHttpError(a){let b,c="HTTPError",
d={400:"Richiesta non valida",401:"Non autorizzato - Controlla la API key",403:"Accesso negato",404:"Endpoint non trovato",429:"Troppe richieste - Rate limit superato",500:"Errore interno del server",503:"Servizio non disponibile"}[a.status]||`Errore HTTP ${a.status}`;try{if(a.headers.get("Content-Type")?.includes("application/json")){if(b=await a.json(),400===a.status&&b){const e="string"===typeof b.error?b.error:b.message||b.error?.message;e&&(e.includes("token limit")||e.includes("token exceeded")||
e.includes("input too long")||e.includes("context length")||e.includes("max tokens"))&&(d="Input troppo lungo - Superato il limite di token",c="TokenLimitError")}}else b=await a.text(),400===a.status&&(b.includes("token limit")||b.includes("input too long")||b.includes("context length"))&&(d="Input troppo lungo - Superato il limite di token",c="TokenLimitError")}catch(e){b={message:"Impossibile estrarre i dettagli dell'errore"}}return this._createError(d,c,a.status,"string"===typeof b?{message:b}:
b)}_handleNetworkError(a){return"AbortError"===a.name?this.isCancelled?this._createError("Richiesta annullata dall'utente","CancellationError",499,{message:"La richiesta \u00e8 stata interrotta volontariamente dall'utente"}):this._createError("Richiesta interrotta per timeout","TimeoutError",408,{message:"La richiesta \u00e8 stata interrotta a causa di un timeout",isTimeout:!0}):"TypeError"===a.name&&a.message.includes("Failed to fetch")?this._createError("Errore di rete","NetworkError",0,{message:"Impossibile raggiungere il server. Controlla la connessione."}):
this._createError("Errore imprevisto",a.name||"UnknownError",500,{message:a.message||"Si \u00e8 verificato un errore sconosciuto"})}async _fetch(a,b,c,d=60){this.isCancelled=!1;this.abortController=new AbortController;const e=this.abortController.signal;d=setTimeout(()=>{this.abortController&&this.abortController.abort()},1E3*d);try{const f=await fetch(a,{method:"POST",headers:c,body:JSON.stringify(b),signal:e});clearTimeout(d);if(this.isCancelled){const h=this._createError("Richiesta annullata",
"CancellationError",499,{message:"La richiesta \u00e8 stata interrotta volontariamente dall'utente"});return this._createResult(!1,null,null,h)}if(!f.ok){const h=await this._handleHttpError(f);return this._createResult(!1,null,null,h)}const g=await f.json();return this._createResult(!0,g)}catch(f){clearTimeout(d);const g=this._handleNetworkError(f);return this._createResult(!1,null,null,g)}finally{this.abortController=null}}}var module$static$js$llmclient$mistral_client={};
module$static$js$llmclient$mistral_client.MistralClient=MistralClient$$module$static$js$llmclient$mistral_client;const DOC_TYPES_CONFIG$$module$static$js$services$doc_types={analitici:"analisi mercato;studio fattibilita;valutazione tecnica;analisi rischi;audit interno;analisi costi benefici".split(";"),argomentativi:"documento scientifico;proposta ricerca;saggio filosofico;tesi laurea;paper accademico;manifesto politico;argomentazione legale".split(";"),documentali:"anamnesi medica;report finanziario;report tecnico;verbale riunione;certificato medico;bilancio aziendale;dichiarazione redditi;registro presenze;inventario magazzino".split(";"),
...
this.isTreeVisible&&this._buildTreeView()):console.error(`Invalid docType selected: ${a}`)},_updateActiveDocTypeDisplay(){const a=document.getElementById("active-doctype-display");a&&(a.textContent=this.config.docType)},selectDocType(){this.toggleTreeView()}};var module$static$js$services$doc_types={DocType:DocType$$module$static$js$services$doc_types};const CLIENTS$$module$static$js$llm_provider={gemini:null,groq:null,mistral:null},PROVIDER_CONFIG$$module$static$js$llm_provider={mistral:{client:"mistral",models:{"mistral-large-latest":{windowSize:128},"mistral-medium-latest":{windowSize:128},"mistral-small-latest":{windowSize:128},"open-mixtral-8x7b":{windowSize:32}}},gemini:{client:"gemini",models:{"gemini-2.0-flash":{windowSize:200},"gemini-2.5-flash":{windowSize:200},"gemini-2.5-flash-lite":{windowSize:200}}},groq:{client:"groq",models:{"llama-3.1-8b-instant":{windowSize:8},
"llama-3.3-70b-versatile":{windowSize:8},"meta-llama/llama-guard-4-12b":{windowSize:8},"qwen/qwen3-32b":{windowSize:8}}}},DEFAULT_PROVIDER_CONFIG$$module$static$js$llm_provider={provider:"gemini",model:"gemini-2.5-flash-lite",windowSize:200,client:"gemini"},LlmProvider$$module$static$js$llm_provider={isTreeVisible:!1,config:{provider:"",model:"",windowSize:0,client:""},container_id:"provvider_id",init(){let a=getApiKey$$module$static$js$services$key_retriever("gemini");CLIENTS$$module$static$js$llm_provider.gemini=
new GeminiClient$$module$static$js$llmclient$gemini_client(a);a=getApiKey$$module$static$js$services$key_retriever("groq");CLIENTS$$module$static$js$llm_provider.groq=new GroqClient$$module$static$js$llmclient$groq_client(a);a=getApiKey$$module$static$js$services$key_retriever("mistral");CLIENTS$$module$static$js$llm_provider.mistral=new MistralClient$$module$static$js$llmclient$mistral_client(a)},initConfig(){const a=UaDb$$module$static$js$services$uadb.readJson(DATA_KEYS$$module$static$js$services$data_keys.KEY_PROVIDER);
this._isValidConfig(a)?this.config=a:(a.provider&&alert("Errore nella configurazione provider/model"),this.config={...DEFAULT_PROVIDER_CONFIG$$module$static$js$llm_provider},UaDb$$module$static$js$services$uadb.saveJson(DATA_KEYS$$module$static$js$services$data_keys.KEY_PROVIDER,this.config));this._updateActiveModelDisplay()},_isValidConfig(a){if(!a||"object"!==typeof a)return!1;const {provider:b,model:c,client:d}=a;return b&&PROVIDER_CONFIG$$module$static$js$llm_provider[b]&&c&&PROVIDER_CONFIG$$module$static$js$llm_provider[b].models[c]&&
"string"===typeof d&&CLIENTS$$module$static$js$llm_provider[d]?!0:!1},getclient(){return CLIENTS$$module$static$js$llm_provider[this.config.client]||null},toggleTreeView(){const a=UaWindowAdm$$module$static$js$services$uawindow.create(this.container_id),b=a.getElement();b&&(a.addClassStyle("provider-tree-container"),this.isTreeVisible=!this.isTreeVisible,b.style.display=this.isTreeVisible?"block":"none",this.isTreeVisible&&this._buildTreeView())},getConfig(){return this.config},_buildTreeView(){const a=
UaWindowAdm$$module$static$js$services$uawindow.get(this.container_id);if(a.getElement()){var b='\n      <div class="provider-tree-header">\n        <span>Seleziona Modello</span>\n        <button class="provider-tree-close-btn">&times;</button>\n      </div>\n      <ul class="provider-tree">\n    ';for(const c in PROVIDER_CONFIG$$module$static$js$llm_provider){const d=PROVIDER_CONFIG$$module$static$js$llm_provider[c],e=c===this.config.provider;b+=`
...
saveChunkResults(a,b){UaDb$$module$static$js$services$uadb.saveArray(this.getChunkResultsKey(a),b)},loadChunkResults(a){return UaDb$$module$static$js$services$uadb.readArray(this.getChunkResultsKey(a))},getDocKbKey:a=>`${DOC_KB_PREFIX$$module$static$js$services$build_state_mgr}${a}`,saveDocKb(a,b){UaDb$$module$static$js$services$uadb.save(this.getDocKbKey(a),b)},loadDocKb(a){return UaDb$$module$static$js$services$uadb.read(this.getDocKbKey(a))}};var module$static$js$services$build_state_mgr={BuildStateMgr:BuildStateMgr$$module$static$js$services$build_state_mgr};const sleep$$module$static$js$rag_engine=a=>new Promise(b=>setTimeout(b,a)),logMessages$$module$static$js$rag_engine=a=>{a=a.messages;console.debug("*** messages **************************************");for(const b of a)console.debug(b.role),console.debug(b.content),console.debug("-------------------------------------")},sendRequest$$module$static$js$rag_engine=async(a,b,c)=>{logMessages$$module$static$js$rag_engine(b);let d=null;for(let e=1;3>=e;e++){const f=await a.sendRequest(b,90);d=f;if(!f||
f.ok)return f;const g=f.error;console.error("****\n",`${c} (Attempt ${e}/${3}):`,g);if(g&&413===g.code)return await alert("Prompt troppo grande per questo Mddel"),a.cancelRequest(),f;if(g&&(408===g.code||[500,502,503,504].includes(g.code)))UaLog$$module$static$js$services$ualog3.log(`Transient error ${g.code}. Retrying in ${5}s...`),await sleep$$module$static$js$rag_engine(5E3);else return f}return d},ragEngine$$module$static$js$rag_engine={docType:null,model:null,client:null,promptSize:0,history:[],
init(a,b,c,d){this.client=a;this.model=b;this.promptSize=c;this.docType=d},async buildKnBase(){var a=BuildStateMgr$$module$static$js$services$build_state_mgr.loadState();const b=DocsMgr$$module$static$js$services$docs_mgr.names();a&&"in_progress"===a.status?UaLog$$module$static$js$services$ualog3.log("Ripresa elaborazione interrotta..."):(UaLog$$module$static$js$services$ualog3.log("Inizio nuova elaborazione Knowledge Base..."),BuildStateMgr$$module$static$js$services$build_state_mgr.clearState(),
a=BuildStateMgr$$module$static$js$services$build_state_mgr.initState(b));const c=[];for(var d=0;d<a.currentDocIndex;d++){var e=a.docNames[d],f=BuildStateMgr$$module$static$js$services$build_state_mgr.loadDocKb(e);f&&c.push(`DOCUMENTO: ${e}\n${f}`)}for(d=a.currentDocIndex;d<b.length;d++){e=b[d];a.currentDocIndex=d;BuildStateMgr$$module$static$js$services$build_state_mgr.updateState(a);UaLog$$module$static$js$services$ualog3.log(`Elaborazione documento ${d+1}/${b.length}: ${e}`);f=DocsMgr$$module$static$js$services$docs_mgr.doc(d);
console.info("prompt size:",this.promptSize);f=splitText$$module$static$js$text_splitter(f,this.promptSize,this.promptSize+1E3);let h=BuildStateMgr$$module$static$js$services$build_state_mgr.loadChunkResults(e);0<h.length?(UaLog$$module$static$js$services$ualog3.log(`Trovati ${h.length} chunk gi\u00e0 processati per ${e}.`),a.currentChunkIndex=h.length):a.currentChunkIndex=0;for(let k=a.currentChunkIndex;k<f.length;k++){var g=f[k];a.currentChunkIndex=k;BuildStateMgr$$module$static$js$services$build_state_mgr.updateState(a);
UaLog$$module$static$js$services$ualog3.log(`Processing chunk ${k+1}/${f.length} di ${e}`);g=await this._extractDataChunk(g);h.push(g);BuildStateMgr$$module$static$js$services$build_state_mgr.saveChunkResults(e,h)}UaLog$$module$static$js$services$ualog3.log(`Unificazione chunk per ${e}...`);f=await this._unifyContents(h);BuildStateMgr$$module$static$js$services$build_state_mgr.saveDocKb(e,f);c.push(`DOCUMENTO: ${e}\n${f}`);a.currentChunkIndex=0;BuildStateMgr$$module$static$js$services$build_state_mgr.updateState(a)}UaLog$$module$static$js$services$ualog3.log("Unificazione finale di tutte le Knowledge Base...");
a=await this._unifyContents(c);await idbMgr$$module$static$js$services$idb_mgr.create(DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE,a);UaLog$$module$static$js$services$ualog3.log("Knowledge Base creata con successo!");BuildStateMgr$$module$static$js$services$build_state_mgr.clearState();return!0},async _extractDataChunk(a){a=promptBuilder$$module$static$js$llm_prompts.extractionPrompt(a,this.docType);a=await sendRequest$$module$static$js$rag_engine(this.client,{model:this.model,messages:a,
random_seed:42,temperature:0,max_tokens:4E3},"ERR1");if(!a||!a.ok)throw a?a.error:Error("Request failed without response");return a.data},async _unifyContents(a){a=a.join("\n\n---\n\n");a=promptBuilder$$module$static$js$llm_prompts.unificationPrompt(a,this.docType);a=await sendRequest$$module$static$js$rag_engine(this.client,{model:this.model,messages:a,random_seed:42,temperature:0,max_tokens:16E3},"ERR2");if(!a||!a.ok)throw a?a.error:Error("Request failed without response");return a.data},async _extractContext(a){const b=
await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE);a=promptBuilder$$module$static$js$llm_prompts.extractorPrompt(b,a,this.docType);a={model:this.model,messages:a,random_seed:42,temperature:0,max_tokens:16E3};UaLog$$module$static$js$services$ualog3.log("Select context.");a=await sendRequest$$module$static$js$rag_engine(this.client,a,"ERR3");if(!a.ok)throw a.error;return a.data},async _getAnswer(a,b){a=promptBuilder$$module$static$js$llm_prompts.answerPrompt(a,
b);console.debug("\n*** _getAnswer messages;\n",a);a={model:this.model,messages:a,random_seed:42,temperature:.7,max_tokens:9E3};UaLog$$module$static$js$services$ualog3.log("Domanda");a=await sendRequest$$module$static$js$rag_engine(this.client,a,"ERR4");if(!a.ok)throw a.error;return a.data},async buildContext(a){await idbMgr$$module$static$js$services$idb_mgr.delete(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD);await idbMgr$$module$static$js$services$idb_mgr.delete(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT);
let b=await this._extractContext(a);await idbMgr$$module$static$js$services$idb_mgr.create(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT,b);UaDb$$module$static$js$services$uadb.save(DATA_KEYS$$module$static$js$services$data_keys.KEY_QUERY,a);this.history=[];this.history.push(`question: ${a}`);a=await this._getAnswer(b,this.history);this.history.push(`answer: ${a}`);await idbMgr$$module$static$js$services$idb_mgr.create(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD,this.history);
UaDb$$module$static$js$services$uadb.save(DATA_KEYS$$module$static$js$services$data_keys.KEY_RESPONSE,a);return this.history},async runConversation(a){let b=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT);if(!b)return this.history=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD),this.history||(this.history=[]),this.history.push(`question: ${a}`),a=await this._getAnswer(b,
this.history),this.history.push(`answer: ${a}`),await idbMgr$$module$static$js$services$idb_mgr.create(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD,this.history),this.history;this.history=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD);this.history||(this.history=[]);this.history.push(`question: ${a}`);a=await this._getAnswer(b,this.history);this.history.push(`answer: ${a}`);await idbMgr$$module$static$js$services$idb_mgr.create(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD,
this.history);return this.history}};var module$static$js$rag_engine={ragEngine:ragEngine$$module$static$js$rag_engine};const tokensToBytes$$module$static$js$app_mgr=(a=32)=>{a*=3072;return Math.trunc(a+.1*a)},AppMgr$$module$static$js$app_mgr={configTD:null,configLLM:null,clientLLM:null,promptSize:0,initApp(){LlmProvider$$module$static$js$llm_provider.init();this.initConfig()},initConfig(){LlmProvider$$module$static$js$llm_provider.initConfig();DocType$$module$static$js$services$doc_types.init();this.configTD=DocType$$module$static$js$services$doc_types.getConfig();this.configLLM=LlmProvider$$module$static$js$llm_provider.getConfig();
this.promptSize=tokensToBytes$$module$static$js$app_mgr(this.configLLM.windowSize);console.info("=============================");console.info(`*** PROVIDER    : ${this.configLLM.provider}`);console.info(`*** MODEL       : ${this.configLLM.model}`);console.info(`*** WINDOW_SIZE : ${this.configLLM.windowSize}`);console.info(`*** PROMPT_SIZE : ${this.promptSize}`);console.info(`*** DOC_TYPE    : ${this.configTD.docType}`);console.info(`*** CLIENT     : ${this.configLLM.client}`);const a=this.configLLM.model,
b=this.promptSize,c=this.configTD.docType;this.clientLLM=LlmProvider$$module$static$js$llm_provider.getclient();ragEngine$$module$static$js$rag_engine.init(this.clientLLM,a,b,c)}};var module$static$js$app_mgr={AppMgr:AppMgr$$module$static$js$app_mgr};const PROMPT_ANSWER$$module$static$js$history_utils="# RISPOSTA",PROMPT_CONTEXT$$module$static$js$history_utils="# CONTESTO:",PROMPT_INITIAL_QUESTION$$module$static$js$history_utils="## DOMANDA INIZIALE:",QUESTION_PREFIX$$module$static$js$history_utils="question:",ANSWER_PREFIX$$module$static$js$history_utils="answer:",ROLE_USER$$module$static$js$history_utils="user",ROLE_ASSISTANT$$module$static$js$history_utils="assistant",ROLE_SYSTEM$$module$static$js$history_utils="system",historyToMessages$$module$static$js$history_utils=
...
e.startsWith("xxx.")||(a=e);return e},d=async(e,f)=>{let g="unavailable";try{g=await c()}catch(h){console.warn("IP non disponibile, continuo senza")}e={appId:e,ip:g,...f};try{const h=new AbortController,k=setTimeout(()=>h.abort(),1E4),m=await fetch("https://simple-moniotr-default-rtdb.europe-west1.firebasedatabase.app/visite.json",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),signal:h.signal});clearTimeout(k);m.ok||console.error("Errore Firebase:",m.status,m.statusText)}catch(h){"AbortError"===
h.name?console.error("Timeout invio Firebase"):console.error("Errore rete Firebase:",h.message)}};return{sendLog(e,f={}){const g=window.location.hostname;"127.0.0.1"===g||"localhost"===g?console.log("Registrazione disattivata in ambiente locale"):d(e,f).catch(h=>{console.error("Errore durante l'invio del log:",h)})},resetIpCache(){b=a=null;console.log("Cache IP resettata, prossima chiamata recuperer\u00e0 un nuovo IP")}}})();var module$static$js$services$firbaselogger={FirebaseLogger:FirebaseLogger$$module$static$js$services$firbaselogger};const WebId$$module$static$js$services$webuser_id=(()=>({get:()=>{var a=(new Date).toISOString(),b=localStorage.getItem("ua_web_id");if(b)return b=JSON.parse(b),b.lastRequest=a,localStorage.setItem("ua_web_id",JSON.stringify(b)),b;b=new URL(window.location.href);a={id:`user_${Date.now()}_${Math.random().toString(36).substring(2,15)}`,firstRequest:a,lastRequest:a,hosname:b.hostname,pathname:b.pathname};localStorage.setItem("ua_web_id",JSON.stringify(a));return a},clear:()=>{localStorage.removeItem("ua_web_id");
...
{this.copyBtn.classList.remove("copied");a.classList.remove("copied")},5E3)}},clear(){document.querySelector("#id-text-out .div-text").textContent=""},async clearHistory(){await confirm("Confermi nuova conversazione ? ")&&(await idbMgr$$module$static$js$services$idb_mgr.delete(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD),setResponseHtml$$module$static$js$app_ui(""))},async clearHistoryContext(){await confirm("Confermi nuovo Contesto & Conversazione ?  ")&&(await idbMgr$$module$static$js$services$idb_mgr.delete(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT),
await idbMgr$$module$static$js$services$idb_mgr.delete(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD),setResponseHtml$$module$static$js$app_ui(""))}},getTheme$$module$static$js$app_ui=()=>{"light"===UaDb$$module$static$js$services$uadb.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_THEME)?document.body.classList.add("theme-light"):document.body.classList.add("theme-dark")},setTheme$$module$static$js$app_ui=a=>{"light"===a?(document.body.classList.remove("theme-dark"),document.body.classList.add("theme-light"),
UaDb$$module$static$js$services$uadb.save(DATA_KEYS$$module$static$js$services$data_keys.KEY_THEME,"light")):(document.body.classList.remove("theme-light"),document.body.classList.add("theme-dark"),UaDb$$module$static$js$services$uadb.save(DATA_KEYS$$module$static$js$services$data_keys.KEY_THEME,"dark"))},showReadme$$module$static$js$app_ui=()=>{wnds$$module$static$js$app_ui.wdiv.show(help1_html$$module$static$js$services$help)},showQuickstart$$module$static$js$app_ui=()=>{wnds$$module$static$js$app_ui.wdiv.show(help2_html$$module$static$js$services$help)},
showQuery$$module$static$js$app_ui=()=>{const a=UaDb$$module$static$js$services$uadb.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_QUERY);a&&wnds$$module$static$js$app_ui.winfo.show(a)},showContextResponse$$module$static$js$app_ui=()=>{const a=UaDb$$module$static$js$services$uadb.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_RESPONSE);a&&wnds$$module$static$js$app_ui.wpre.show(a)},showThread$$module$static$js$app_ui=async()=>{var a=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD);
a&&(a=messages2text$$module$static$js$history_utils(a),wnds$$module$static$js$app_ui.wpre.show(a))},showHtmlThread$$module$static$js$app_ui=async()=>{var a=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD);a&&(a=messages2html$$module$static$js$history_utils(a),setResponseHtml$$module$static$js$app_ui(a))},showKnBase$$module$static$js$app_ui=async()=>{const a=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE);
a&&wnds$$module$static$js$app_ui.wpre.show(a)},saveKnBase$$module$static$js$app_ui=async()=>{const a=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE);if(a){var b=await prompt("Nome Knowledge Base");b&&(b=b.replace(" ","_"),await idbMgr$$module$static$js$services$idb_mgr.create(`${DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE_PRE}${b}`,a))}else alert("Knowledge Base Vuota")},showContesto$$module$static$js$app_ui=async()=>{const a=
await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT);a&&wnds$$module$static$js$app_ui.wpre.show(a)},saveContesto$$module$static$js$app_ui=async()=>{const a=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT);if(a){var b=await prompt("Nome Contesto");b&&(b=b.replace(" ","_"),await idbMgr$$module$static$js$services$idb_mgr.create(`${DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT_PRE}${b}`,
a))}else alert("Contesto Vuoto")},saveThread$$module$static$js$app_ui=async()=>{const a=await idbMgr$$module$static$js$services$idb_mgr.read(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD);if(a&&0!==a.length){var b=await prompt("Nome per archiviare la conversazione:");b&&(b=b.replace(/\s+/g,"_"),await idbMgr$$module$static$js$services$idb_mgr.create(`${DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD_PRE}${b}`,a),alert(`Conversazione salvata come: ${b}`))}else alert("Nessuna conversazione da salvare.")},
KEY_DESCRIPTIONS$$module$static$js$app_ui={[DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE]:"Knowledge Base Corrente",[DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT]:"Contesto Corrente",[DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD]:"Conversazione Corrente",[DATA_KEYS$$module$static$js$services$data_keys.KEY_PROVIDER]:"Configurazione Provider",[DATA_KEYS$$module$static$js$services$data_keys.KEY_DOC_TYPE]:"Tipo Documento",[DATA_KEYS$$module$static$js$services$data_keys.KEY_THEME]:"Tema UI (dark/light)",
[DATA_KEYS$$module$static$js$services$data_keys.KEY_RESPONSE]:"Risposta Contestuale",[DATA_KEYS$$module$static$js$services$data_keys.KEY_QUERY]:"Query per Creazione Contesto",[DATA_KEYS$$module$static$js$services$data_keys.KEY_DOCS]:"Elenco Documenti Caricati"},getDescriptionForKey$$module$static$js$app_ui=a=>KEY_DESCRIPTIONS$$module$static$js$app_ui[a]?KEY_DESCRIPTIONS$$module$static$js$app_ui[a]:a.startsWith(DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE_PRE)?"Knowledge Base":a.startsWith(DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT_PRE)?
"Contesto":a.startsWith(DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD_PRE)?"Conversazione":"Dato non classificato",elencoDati$$module$static$js$app_ui=async()=>{const a=UaJtfh$$module$static$js$services$uajtfh(),b=[DATA_KEYS$$module$static$js$services$data_keys.KEY_KNBASE,DATA_KEYS$$module$static$js$services$data_keys.KEY_CONTEXT,DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD];a.append('<table class="table-data"><thead><tr><th>Chiave</th><th>Descrizione</th><th>Dimensione</th></tr></thead><tbody>');
for(var c of b){var d=getDescriptionForKey$$module$static$js$app_ui(c),e=await idbMgr$$module$static$js$services$idb_mgr.read(c);e=e?JSON.stringify(e).length:0;a.append(`<tr>
  ...
  <td>${c}</td>
  <td class="size">${d}</td>
</tr>`);a.append("</tbody></table>");wnds$$module$static$js$app_ui.winfo.show(a.html());wnds$$module$static$js$app_ui.winfo.w.getElement().querySelectorAll(".link-show-data").forEach(f=>{f.addEventListener("click",async g=>{g.preventDefault();var h=g.currentTarget.dataset.key;if(h===DATA_KEYS$$module$static$js$services$data_keys.KEY_DOCS)h=DocsMgr$$module$static$js$services$docs_mgr.names().join("\n"),wnds$$module$static$js$app_ui.wpre.show(h,!1);else{g=g.currentTarget.dataset.storageType;var k;"ls"===
g?k=UaDb$$module$static$js$services$uadb.read(h):"idb"===g&&(k=await idbMgr$$module$static$js$services$idb_mgr.read(h));k=k??"";h="string"===typeof k?k:JSON.stringify(k,null,2);wnds$$module$static$js$app_ui.wpre.show(h,!1)}})})},elencoDocs$$module$static$js$app_ui=()=>{var a=DocsMgr$$module$static$js$services$docs_mgr.names();const b=UaJtfh$$module$static$js$services$uajtfh();b.append('<div class="docs-dialog">');b.append("<h4>Elenco Documenti</h4>");0<a.length?(b.append('\n      <table class="table-data">\n        <thead>\n          <tr>\n            <th>Nome</th>\n            <th>Azioni</th>\n          </tr>\n        </thead>\n        <tbody>\n    '),
...
<td><input type="checkbox" data-key="${e}" data-storage="idb"> ${e}</td>
<td>${getDescriptionForKey$$module$static$js$app_ui(e)}</td>
</tr>`)}));a.append("</table>");a.append('<div class="delete-actions">');a.append('<button id="delete-selected-btn" class="btn-delete-selected">Cancella Selezionati</button>');a.append('<button id="delete-all-btn" class="btn-delete-all">Cancella Tutto</button>');a.append("</div>");a.append("</div>");wnds$$module$static$js$app_ui.winfo.show(a.html());const d=wnds$$module$static$js$app_ui.winfo.w.getElement();d.querySelector("#delete-selected-btn").addEventListener("click",async()=>{var e=[],f=[];d.querySelectorAll('input[type="checkbox"]:checked').forEach(g=>
{const h=g.dataset.storage;g=g.dataset.key;"ls"===h?e.push(g):"idb"===h&&f.push(g)});if(0===e.length&&0===f.length)alert("Nessun elemento selezionato.");else if(await confirm("Confermi la cancellazione degli elementi selezionati?")){for(const g of e)g==DATA_KEYS$$module$static$js$services$data_keys.KEY_DOCS?DocsMgr$$module$static$js$services$docs_mgr.deleteAll():UaDb$$module$static$js$services$uadb.delete(g);for(const g of f)await idbMgr$$module$static$js$services$idb_mgr.delete(g),[DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD,
DATA_KEYS$$module$static$js$services$data_keys.KEY_THREAD_PRE].includes(g)&&setResponseHtml$$module$static$js$app_ui("");await alert("Dati selezionati cancellati con successo.");wnds$$module$static$js$app_ui.winfo.close()}});d.querySelector("#delete-all-btn").addEventListener("click",async()=>{await confirm("ATTENZIONE: Stai per cancellare TUTTI i dati gestiti dall'applicazione (LocalStorage e IndexedDB). Confermi?")&&(UaDb$$module$static$js$services$uadb.clear(),await idbMgr$$module$static$js$services$idb_mgr.clearAll(),
setResponseHtml$$module$static$js$app_ui(""),alert("Tutti i dati dell'applicazione sono stati cancellati."),wnds$$module$static$js$app_ui.winfo.close())})},showEsempiDocs$$module$static$js$app_ui=async()=>{const a=await requestGet$$module$static$js$services$http_request("./data/help_test.html");wnds$$module$static$js$app_ui.winfo.show(a);wnds$$module$static$js$app_ui.winfo.w.getElement().querySelectorAll(".doc-esempio").forEach(b=>{b.addEventListener("click",async c=>{c.preventDefault();if(c=c.currentTarget.dataset.exampleName){var d=
`data/${c}`;c=await requestGet$$module$static$js$services$http_request(d);c=cleanDoc$$module$static$js$text_cleaner(c);d=d.split("/");d=d[d.length-1];DocsMgr$$module$static$js$services$docs_mgr.exists(d)?alert(`Il documento ${d} \u00e8 gi\u00e0 caricato`):(DocsMgr$$module$static$js$services$docs_mgr.add(d,c),wnds$$module$static$js$app_ui.winfo.close())}})})};
...
()=>TextInput$$module$static$js$app_ui.send2());document.querySelector(".clear-input").addEventListener("click",()=>TextInput$$module$static$js$app_ui.clear());document.querySelector(".copy-output").addEventListener("click",()=>TextOutput$$module$static$js$app_ui.copy());document.querySelector(".wnd-output").addEventListener("click",()=>TextOutput$$module$static$js$app_ui.openWnd());document.querySelector("#clear-history1").addEventListener("click",()=>TextOutput$$module$static$js$app_ui.clearHistory());
document.querySelector("#clear-history2").addEventListener("click",()=>TextOutput$$module$static$js$app_ui.clearHistoryContext());const a=document.querySelector("#id-menu-btn");a.addEventListener("change",()=>{document.querySelector("body").classList.toggle("menu-open",a.checked);const b=document.querySelector("body"),c=document.querySelector("#id-menu-btn");b.classList.contains("menu-open")?c.setAttribute("data-tt","Close"):c.setAttribute("data-tt","Open")})}
var module$static$js$app_ui={Commands:Commands$$module$static$js$app_ui,TextInput:TextInput$$module$static$js$app_ui,TextOutput:TextOutput$$module$static$js$app_ui};module$static$js$app_ui.bindEventListener=bindEventListener$$module$static$js$app_ui;module$static$js$app_ui.getTheme=getTheme$$module$static$js$app_ui;module$static$js$app_ui.showHtmlThread=showHtmlThread$$module$static$js$app_ui;module$static$js$app_ui.wnds=wnds$$module$static$js$app_ui;const DialogManager$$module$static$js$services$uadialog={escapeHtml(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")},createDialog(a,b,c=""){const d=document.createElement("div"),e=document.createElement("div");d.className=`${a}-dialog`;d.classList.add("inv");e.className="overlay";c="prompt"===a?`<input type="text" class="prompt-input" value="${this.escapeHtml(c)}">`:"";b=this.escapeHtml(b);d.innerHTML=`
      ...
      </div>`;d.setAttribute("role","dialog");d.setAttribute("aria-modal","true");[d,e].forEach(f=>{f.classList.add("show");document.body.appendChild(f)});return{dialog:d,overlay:e}},closeDialog(a,b){[a,b].forEach(c=>{c.classList.remove("show");setTimeout(()=>c.remove(),300)})},async showDialog(a,b,c){return new Promise(d=>{var e=document.querySelector(".overlay.show");if(e){const n=document.querySelector(".dialog.show");this.closeDialog(n,e)}const {dialog:f,overlay:g}=this.createDialog(a,b,c),h=
f.querySelector(".ok");e=f.querySelector(".cancel");const k=n=>{this.closeDialog(f,g);d(n);document.removeEventListener("keydown",m);g.removeEventListener("click",l)},m=n=>{"Escape"===n.key&&k("confirm"===a?!1:null)},l=()=>{k("confirm"===a?!1:null)};document.addEventListener("keydown",m);g.addEventListener("click",l);if("prompt"===a){const n=f.querySelector(".prompt-input");n.focus();n.select();h.onclick=()=>{k(n.value)};e.onclick=()=>{k(null)};n.addEventListener("keydown",p=>{"Enter"===p.key&&h.click()})}else"confirm"===
a?(h.onclick=()=>{k(!0)},e.onclick=()=>{k(!1)}):(h.onclick=()=>{k(void 0)},g.onclick=()=>{k(void 0)})})}},nativeAlert$$module$static$js$services$uadialog=window.alert,nativeConfirm$$module$static$js$services$uadialog=window.confirm,nativePrompt$$module$static$js$services$uadialog=window.prompt;window.alert=async function(a){a instanceof Error&&(a=a.message);return DialogManager$$module$static$js$services$uadialog.showDialog("alert",a)};
window.confirm=async function(a){return DialogManager$$module$static$js$services$uadialog.showDialog("confirm",a)};window.prompt=async function(a,b=""){return DialogManager$$module$static$js$services$uadialog.showDialog("prompt",a,b)};var module$static$js$services$uadialog={DialogManager:DialogManager$$module$static$js$services$uadialog};const VERSIONE$$module$static$js$app=" 0.1.8";console.log("*** VERSIONE:",VERSIONE$$module$static$js$app);
...
const a=WebId$$module$static$js$services$webuser_id.get();FirebaseLogger$$module$static$js$services$firbaselogger.sendLog("open",a)}catch(a){console.error("Si \u00e8 verificato un errore durante l'inizializzazione dell'app:",a)}}window.addEventListener("load",openApp$$module$static$js$app);var module$static$js$app={};const SYSTEM$$module$static$js$xx1="system",USER$$module$static$js$xx1="user",ASSISTANT$$module$static$js$xx1="assistant",assembler$$module$static$js$xx1={messages:[],setSystemMessage(a){this.messages=this.messages.filter(b=>b.role!==SYSTEM$$module$static$js$xx1);this.messages.unshift({role:SYSTEM$$module$static$js$xx1,content:a});return this},addUserMessage(a){this.messages.push({role:USER$$module$static$js$xx1,content:a});return this},addAssistantMessage(a){this.messages.push({role:ASSISTANT$$module$static$js$xx1,
content:a});return this},getMessages(){const a=[...this.messages];for(let b=0;b<a.length;b++)a[b].content=a[b].content.replace(/^(\S+):\s*/g,"");return a},clear(){this.messages=[];return this}},promptBuilder$$module$static$js$xx1={answerPrompt:(a,b)=>{const c=`
# Domanda
${b[0]}
`;assembler$$module$static$js$xx1.messages=[];assembler$$module$static$js$xx1.setSystemMessage(a?`
Sei un assistente esperto che risponde in modo chiaro, naturale e basato sui fatti.
...
2.  Cerca la risposta all'interno del CONTESTO fornito.
3.  Sintetizza le informazioni pertinenti in una risposta chiara e naturale, rispettando tutte le regole.
`:"\nSei un libero pensatore ribelle ad ogni censura e ad ogni convenzione moralistica.\nInterpreta l'intento dell'utente.\nAdatta la tua risposta all'intento percepito (domanda, richiesta di azione, istruzione, ecc.).\nSe l'intento non \u00e8 chiaro, chiedi gentilmente chiarimenti.         \n            ");assembler$$module$static$js$xx1.addUserMessage(c);for(a=1;a<b.length;a++)0===(a-1)%2?assembler$$module$static$js$xx1.addAssistantMessage(b[a]):assembler$$module$static$js$xx1.addUserMessage(b[a]);
return assembler$$module$static$js$xx1.getMessages()}};var module$static$js$xx1={promptBuilder:promptBuilder$$module$static$js$xx1};const adaptHuggingFacePayload$$module$static$js$llmclient$huggingface_client=a=>{if(!a.model)throw Error("Il parametro 'model' \u00e8 obbligatorio nel payload per HuggingFace.");a={model:a.model,messages:a.messages,temperature:a.temperature,max_tokens:a.max_tokens,top_p:a.top_p,top_k:a.top_k,stop:a.stop};for(const b in a)void 0===a[b]&&delete a[b];return a};
class HuggingFaceClient$$module$static$js$llmclient$huggingface_client{constructor(a){this.apiKey=a;this.baseUrl="https://router.huggingface.co/v1/chat/completions";this.abortController=null;this.isCancelled=!1}async sendRequest(a,b=60){const c=this.baseUrl,d={"Content-Type":"application/json",Authorization:`Bearer ${this.apiKey}`};let e;try{e=adaptHuggingFacePayload$$module$static$js$llmclient$huggingface_client(a)}catch(f){return this._createResult(!1,null,null,this._createError(f.message,"ValidationError"))}a=
await this._fetch(c,e,d,b);if(a.ok)try{return this._createResult(!0,a.response,a.response.choices[0].message.content)}catch(f){return this._createResult(!1,null,null,this._createError("Invalid response structure","ParsingError",null,f))}else return a}cancelRequest(){this.isCancelled=!0;return this.abortController?(this.abortController.abort(),this.abortController=null,!0):!1}_createResult(a,b=null,c=null,d=null){return{ok:a,response:b,data:c,error:d}}_createError(a,b,c,d){return{message:a||null,type:b||
null,code:c||null,details:{message:d?.message||null,type:d?.type||null,param:d?.param||null,code:d?.code||null}}}async _handleHttpError(a){let b,c="HTTPError",d={400:"Richiesta non valida",401:"Non autorizzato - Controlla la API key",403:"Accesso negato",404:"Endpoint non trovato",429:"Troppe richieste - Rate limit superato",500:"Errore interno del server",503:"Servizio non disponibile"}[a.status]||`Errore HTTP ${a.status}`;try{if(a.headers.get("Content-Type")?.includes("application/json")){if(b=
...
return this._createResult(!1,null,null,g)}finally{this.abortController=null}}}var module$static$js$llmclient$huggingface_client={};module$static$js$llmclient$huggingface_client.HuggingFaceClient=HuggingFaceClient$$module$static$js$llmclient$huggingface_client;
