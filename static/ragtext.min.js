...
console.log(`*** ADAPTERE    : ${a}`);console.log(` ${b}`);ragEngine$$module$static$js$rag_engine.init(this.clientLLM,this.configLLM.model,this.promptSize,this.configTD.docType)}};var module$static$js$app_mgr={AppMgr:AppMgr$$module$static$js$app_mgr};const PROMPT_ANSWER$$module$static$js$history_utils="# RISPOSTA",PROMPT_CONTEXT$$module$static$js$history_utils="# CONTESTO:",PROMPT_INITIAL_QUESTION$$module$static$js$history_utils="## DOMANDA INIZIALE:",QUESTION_PREFIX$$module$static$js$history_utils="question:",ANSWER_PREFIX$$module$static$js$history_utils="answer:",ROLE_USER$$module$static$js$history_utils="user",ROLE_ASSISTANT$$module$static$js$history_utils="assistant",ROLE_SYSTEM$$module$static$js$history_utils="system",historyToMessages$$module$static$js$history_utils=
